...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 400">
  ...
  <!-- Supply Chain Path -->
  <path d="M50 200 H750" stroke="#3498db" stroke-width="4" fill="none"/>
  
  <!-- Supplier -->
  <g transform="translate(50, 200)">
    <rect x="-30" y="-30" width="60" height="60" fill="#e74c3c" rx="10">
      <animate attributeName="opacity" values="1;0.7;1" dur="2s" repeatCount="indefinite"/>
    </rect>
    <text x="0" y="50" text-anchor="middle" fill="#333">Supplier</text>
  </g>
  
  <!-- Manufacturer -->
  <g transform="translate(250, 200)">
    <rect x="-40" y="-40" width="80" height="80" fill="#f39c12" rx="10">
      <animate attributeName="transform" attributeType="XML" type="scale" values="1;1.1;1" dur="3s" repeatCount="indefinite"/>
    </rect>
    <text x="0" y="60" text-anchor="middle" fill="#333">Manufacturer</text>
  </g>
  
  <!-- Distributor -->
  <g transform="translate(450, 200)">
    <polygon points="0,-30 35,15 -35,15" fill="#27ae60">
    ...
    <text x="0" y="50" text-anchor="middle" fill="#333">Distributor</text>
  </g>
  ...
  <g transform="translate(650, 200)">
    ...
    <text x="0" y="60" text-anchor="middle" fill="#333">Retailer</text>
  </g>
  
  <!-- Moving Product -->
  <circle r="10" fill="#e74c3c">
    <animateMotion path="M50 200 H750" dur="5s" repeatCount="indefinite"/>
  </circle>
  
  <!-- Title -->
  <text x="400" y="50" text-anchor="middle" font-size="24" font-weight="bold" fill="#333">Supply Chain Management</text>
</svg>
<dl>
<dt>Course Name</dt>
...
- Codes contain only the implementation of used algorithms and the whole codes.
